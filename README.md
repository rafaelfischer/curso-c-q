...
## Desenvolvendo em Linguagem C
É possível utilizar compilador online [Online C Compiler](https://www.onlinegdb.com/) ou ainda utilizar o VSCode para compilar e rodar programar criados na linguagem C 
...
> O nome do programa neste exemplo é: nome_do_programa, e o nome do arquivo a ser salvo é: nome_do_programa.c\
...
int main() {
    ...
    //sinaliza para o sistema operacional que o programa finalizou com sucesso   
    return 0;
}
```
